  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="" className="">{name}</Button>
      </DialogTrigger>
            ...
            <DialogDescription asChild>
              <div className="px-6 py-4">
                ...
                <div className="flex flex-col text-black">
                  <div className="grid grid-cols-4 gap-2 p-2 border-b font-semibold bg-gray-100 rounded-md rounded-br-none rounded-bl-none">
                    <div>File Name</div>
                    <div>IPFS URL</div>
                  ...
                  {fileDetails?.map((file, index) => (
                    ...
                    >
                      ...
                      <div className="w-fit pr-5 -ml-2">
                        <CopyInput value={file[2]} />
                      </div>

                      <div className="w-fit pr-5 -ml-2">
                        <CopyInput value={file[3]} />
                      </div>
                      <AccessPassword />
                    </div>
                  ))}
